            ...
            <div class="vc_column-inner ">
                <div class="wpb_wrapper">
                    <div class="custom-information  intro-adv2">
                        <h2 class="title30 font-bold text-uppercase dosis-font text-center">What do you need?</h2>
                        <h3 class="title18 font-bold text-uppercase dosis-font text-center gray">This is hints for you!</h3>
