					...
					<table class="shop_table shop_table_responsive cart woocommerce-cart-form__contents" cellspacing="0">
						<thead>
							<tr style="color: black;">
								...
								<th style="width: 100px" class="product-thumbnail">Image</th>
							...
							@foreach($dog_add as $dog_add)
								<tbody>
									<tr class="woocommerce-cart-form__cart-item cart_item">
										<td class="product-remove"><a href="{{route('home.del',$dog_add['item']['id'])}}" class="remove" aria-label="Remove this item" data-product_id="724" data-product_sku="DSP23684">&times;</a></td>
										...
										class="detail-qty info-qty border radius6" style="color: black;">
										<a
										href="{{route('home.del',$dog_add['item']['id'])}}" class="qty-down" style="color: black;"><i
										...
										class="fa fa-angle-up" aria-hidden="true"></i></a></div></td>
